...
const demarchePage = layout({
  ...
  content:`<section class="letter-hero"><div class="container"><span class="eyebrow light">La démarche</span><h1><em>« Le redressement de la France ne se fera ni par des slogans ni par des demi-mesures, mais par une Vision forte et claire, traduite en choix cohérents, financés et tenus dans la durée. »</em></h1><p class="letter-hero-meta">Programme commencé le 15 février 2026 et achevé le 30 août 2026.</p><div class="hero-actions">${downloadButton('/downloads/lettre-presentation-demarche-france2035.pdf','Télécharger la lettre de présentation au format PDF')}</div></div></section>
...
const programmePage = layout({
  ...
  <section class="status-note"><div class="container"><strong>Transparence budgétaire</strong><p>Le programme publié indique que les trajectoires des années 1 à 15 sont suspendues et non certifiées. Les propositions restent consultables ; les activations conditionnelles sont clairement distinguées des engagements.</p></div></section>
...
const simulationsPage = layout({
  ...
  <section class="status-note"><div class="container"><strong>À lire avant les résultats</strong><p>Les cas sont indicatifs, non certifiés, non opposables et non extrapolables. Les valeurs à partir de l’année 6 sont provisoires : le paramètre de déficit de 4,35 % en année 6 n’a pas encore été microsimulé.</p></div></section>
...
const calendarPage = layout({
  ...
  <section class="status-note"><div class="container"><strong>Garde-fou d’exécution</strong><p>L’année 1 correspond à 2028, l’année 10 à 2037 et l’année 15 à 2042. Pour les années 7 à 15, les scénarios budgétaires restent en cours : les activations conditionnelles demeurent suspendues à une trajectoire certifiée.</p></div></section>
...
const sitemapEntries = [
  ['/', '2026-09-15'],
  ['/la-demarche/', '2026-09-14'],
  ['/programme/', '2026-09-12'],
  ['/budget/', '2026-09-12'],
  ['/simulations-impact/', '2026-09-12'],
  ['/calendrier-execution/', '2026-09-12'],
